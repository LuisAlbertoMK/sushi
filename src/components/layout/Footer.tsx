...
type SocialIconName = "instagram" | "whatsapp";

type SocialIconProps = {
  name: SocialIconName;
};

// Glyphs oficiales (Simple Icons) — fill="currentColor" hereda el color del texto
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center bg-gray-800 dark:bg-gray-800 p-2 rounded-full text-gray-200 dark:text-gray-300 hover:text-primary-300 transition"
